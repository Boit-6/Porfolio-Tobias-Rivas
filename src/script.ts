...
const text: Record<Languages, TextContent> = {
    es: {
        subtitle: 'Estudiante • Desarrollador Junior',
        aboutHeading: 'Sobre mi',
        aboutParagraphEl:
            'Estudiante de programación con una experiencia en el área de Electrónica y en el área de soporte técnico. Buscando crecer como Desarrollador Junior, contribuyendo con habilidades en desarrollo web y bases de datos, combinados con trabajo en equipo, aprendizaje rápido y adaptabilidad.',
        skillsHeading: 'Habilidades',
        projectsHeading: 'Proyectos',
        projectDescription:
            'Apuestcraft es un proyecto en el que deseo tomar mis primeros pasos en programación. Es un pequeño (falso) casino temático en Minecraft que desarrollé usando HTML, CSS y JavaScript.',
    ...
    en: {
        ...
        aboutParagraphEl:
            'Programming student with a background in Electronics and experience in technical support. Seeking to grow as a Junior Developer, contributing skills in web development and databases, combined with teamwork, quick learning, and adaptability.',
        skillsHeading: 'Skills',
        projectsHeading: 'Projects',
        projectDescription:
            'Apuestcraft is a project with which I wanted to take my first steps in programming. It is a small (fake) casino themed around Minecraft that I developed using HTML, CSS and JavaScript.',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyLanguage(lang: Languages) {
        ...
        setText(skillsHeadingEl as Element, text[lang].skillsHeading);
    ...
    if (langButton) {
        langButton.addEventListener('click', () => {
            ...
            const next: Languages = current === 'es' ? 'en' : 'es';
            setLanguage(next);
            applyLanguage(next);
        });
    }
    ...
    const themeButtonEl = document.querySelector('.page-actions__theme-button') as HTMLButtonElement | null;
